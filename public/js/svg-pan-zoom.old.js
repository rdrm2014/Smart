// CHANGE LIST:
//
// LINE 704 - DON'T PAN ON ALT KEY PRESSED
...
(function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);throw new Error("Cannot find module '"+o+"'")}var f=n[o]={exports:{}};t[o][0].call(f.exports,function(e){var n=t[o][1][e];return s(n?n:e)},f,f.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s})({1:[function(require,module,exports){
    module.exports = {
        enable: function(instance) {
            ...
            zoomGroup.setAttribute('transform', 'translate(15 15) scale(0.75)');
...
// UMD module definition
    ...
    SvgPanZoom.prototype.handleMouseDown = function(evt, prevEvt) {
        ...
        // EDITADO (previne o arrastamento da planta consoante a ação do utilizador)
        if(evt.ctrlKey || mousedown_node || scaling || holdPan) {
            console.log('hold pan (svg-pan-zoom.old.js):706');
            return;
        }
